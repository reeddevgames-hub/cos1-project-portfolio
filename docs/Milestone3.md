...
→ **Standardized Coding Conventions**: Refactored function input arguments and structural signatures to strickly use 'snake_case' style. what is updated so far is Account.h, Account.cpp, MenuInterface.h, MenuInterface.cpp, StorageManager.h, and StorageManager.cpp files.
